...
class HourlyModel : OrmTable {
    ...
    override fun toString(): String {
        return "HourlyModel(id=$id, status=$status, api_version=$api_version, api_status=$api_status, lang=$lang, unit=$unit, tzshift=$tzshift, timezone=$timezone, server_time=$server_time, location=$location, result=$result)"
    }
}